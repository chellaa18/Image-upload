export const abi = [
  ...
  { inputs: [], name: "Invalid_Balance", type: "error" },
  { inputs: [], name: "Invalid_Contract_Balance", type: "error" },
  { inputs: [], name: "Invalid_Status", type: "error" },
  { inputs: [], name: "Is_Contract", type: "error" },
  { inputs: [], name: "Not_An_Owner", type: "error" },
  { inputs: [], name: "Not_Approved_Token", type: "error" },
  { inputs: [], name: "ReEntrant", type: "error" },
  { inputs: [], name: "Token_MissMatch", type: "error" },
